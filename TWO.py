...
# email_user = 'vehicaldetaction@gmail.com'
# email_password = '123dsa321'
        ...
        for carID in carTracker.keys():
            ...
            if carID not in startTracker and mark2 > ty+th > mark1 and ty < mark1:
                ...
                if speed > speedLimit:
                    ...
                    list_of_files = glob.glob(r'C:\Users\HOME\Downloads\vehicle-speed-detection\vehicle-speed-detection\overspeeding\cars/*') # * means all if need specific format 
